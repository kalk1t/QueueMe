...
| No unresolved action markers remain | PASS | Scan result shows no unresolved action markers in this milestone's normative artifacts. |
...
| Marker reconciliation (normative/supporting) | PASS | No normative action-markers remain and no unresolved marker hits were found. |
